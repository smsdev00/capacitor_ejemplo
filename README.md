...
Copiar el siguiente index.html a proyecto_root/src/, podría ser cualquier html
...
El nombre de la app capacitor, en este caso com.example.app2", debe estar en formato dns reverso
